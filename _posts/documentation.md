...
<div class="figure">
<div class="terminal">
  <div class="terminal-bar" aria-hidden="true"><span class="terminal-dot"></span><span class="terminal-dot"></span><span class="terminal-dot"></span><span class="terminal-title">draft — 2603.23420.pdf</span></div>
  <div class="terminal-screen" tabindex="0" role="group" aria-label="the draft run, phase by phase">
<p class="tui-head">Drafting Grounded Articles — claude · sonnet · 900–1200 words</p>
<p class="tui-phase tui-done"><span class="tui-marker">✓</span>Resolve source</p>
<p class="tui-phase tui-done"><span class="tui-marker">✓</span>Read and section <span class="tui-note">· 5 sections</span></p>
<p class="tui-phase tui-run"><span class="tui-marker">⠙</span>Extract claims <span class="tui-note">· claim section 3/5</span></p>
<p class="tui-phase tui-pending"><span class="tui-marker">·</span>Write article</p>
<p class="tui-phase tui-pending"><span class="tui-marker">·</span>Validate and save</p>
<p class="tui-bar">q / esc quit · enter queue another source · j / k · arrows · pgup / pgdn scroll</p>
  </div>
</div>
<p class="term-caption">The terminal UI as a run proceeds. A muted <code>·</code> is a phase not started, the coral spinner is the phase running now, and a green <code>✓</code> is one done. Prefer no UI? Add <code>--print</code> (paths to stdout) or <code>--json</code> (one JSON object per job).</p>
</div>
